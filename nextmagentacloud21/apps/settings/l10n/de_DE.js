OC.L10N.register(
    ...
    "Profile picture" : "Profilbild test123",
    ...
    "You can terminate individual sessions here or remove them completely.": "Sie können einzelne Sitzungen hier beenden oder ganz entfernen.",
    "When terminating, a new login is necessary.": "Beim Beenden wird ein erneuter Login notwendig.",
    "If you delete a session, all data of your MagentaCLOUD on the respective device will also be removed.": "Löschen sie eine Sitzungen werden auch alle Daten ihrer MagentaCLOUD auf dem betreffenden Gerät entfernt.",
    "You can manually create a new session here and connect a new device to your MagentaCLOUD via login data or QR code.": "Sie können hier manuell eine neue Sitzungen erstellen und per Login Daten oder QR Code ein neues Gerät mit ihrer MagentaCLOUD verbinden.",
