OC.L10N.register(
    ...
    "You can add an alternative email address to receive your notifications there. It will also be used as an address for shared content. Your password can can be changed in the": "You can add an alternative email address to receive your notifications there. It will also be used as an address for shared content. Your password can can be changed in the",
    "Select this email address": "Select this email address",
    "Deselect this email address": "Deselect this email address",
