...
<div id="app-content">
  ...
  <?php } else { ?>
    ...
    <div id="public-upload">
      <div id="emptycontent" class="<?php if (!empty($_['note'])) { ?>has-note<?php } ?>">
        <?php if ($_['shareOwner']) { ?>
  ...
  <?php if (!isset($_['hideFileList']) || (isset($_['hideFileList']) && $_['hideFileList'] !== true)) : ?>
    ...
    <div class="hiddenuploadfield">
      <input type="file" id="file_upload_start" class="hiddenuploadfield" name="files[]" data-url="<?php p(\OC::$server->getURLGenerator()->linkTo('files', 'ajax/upload.php')); ?>" />
    </div>
  <?php endif; ?>
</div>
