...
<head data-user="<?php p($_['user_uid']); ?>" data-user-displayname="<?php p($_['user_displayname']); ?>" data-requesttoken="<?php p($_['requesttoken']); ?>">
  ...
  <link rel="mask-icon" sizes="any" href="<?php print_unescaped($theme->getBaseUrl().'core/img/favicon-mask.svg'); ?>" color="<?php p($theme->getColorPrimary()); ?>">
  <link rel="manifest" href="<?php print_unescaped(image_path($theme->getBaseUrl(), 'manifest.json')); ?>">
                  ...
                  <li data-id="<?php p($entry['id']); ?>">
                    <a href="<?php $entry['id'] == "help" ? print_unescaped("https://cloud.telekom-dienste.de/hilfe") : print_unescaped($entry['href']); ?>" <?php if ($entry["active"]) : ?> class="active" <?php endif; ?>>
                      <?php if ($entry['id'] == "settings") { ?>
                        <img alt="" src="<?php print_unescaped($theme->getBaseUrl().'core/img/settings/img/admin.svg' . '?v=' . $_['versionHash']); ?>">
                        <?php p($entry['name']); ?>
                      <?php } elseif ($entry['id'] == "help") { ?>
                        <img alt="" src="<?php print_unescaped($theme->getBaseUrl().'core/img/settings/img/help.svg' . '?v=' . $_['versionHash']); ?>">
                        <?php p($l->t('Help & FAQ')); ?>
                      <?php } elseif ($entry['id'] == "logout") { ?>
                        <img alt="" src="<?php print_unescaped($entry['icon'] . '?v=' . $_['versionHash']); ?>">
                        <?php p($l->t('Logout')); ?>
                      <?php } elseif ($entry['id'] == "core_apps") { ?>
                        <img alt="" src="<?php print_unescaped($theme->getBaseUrl().'core/img/settings/img/apps.svg' . '?v=' . $_['versionHash']); ?>">
                        <?php p($entry['name']); ?>
                      <?php } elseif ($entry['id'] == "core_users") { ?>
                        <img alt="" src="<?php print_unescaped($theme->getBaseUrl().'core/img/settings/img/users.svg' . '?v=' . $_['versionHash']); ?>">
                        <?php p($entry['name']); ?>
                      <?php } else { ?>
                        <img alt="" src="<?php print_unescaped($entry['icon'] . '?v=' . $_['versionHash']); ?>">
                      <?php p($entry['name']);
