...
(function() {
	...
	FileList.prototype = {
		...
		_onResize: function() {
			...
			$.each($('#content').find('#controls .actions'), function(index, action) {
		...
		showActions: function(show){
			...
			if (show){
				...
				$('#content').find('#controls .crumb').remove();
		...
		highlightFiles: function(files, highlightFunction) {
			...
			var additionalOffset = $('#content').find("#controls").height()+$('#content').find("#controls").offset().top;	
		...
		_renderNewButton: function() {
			...
			var $actionsContainer = $('#content').find('#controls .actions');
