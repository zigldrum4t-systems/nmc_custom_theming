  ...
  render() {
    ...
    return (h(Host, null,
      ...
      h(Element, Object.assign({ part: this.getBasePartMap(), class: this.getCssClassMap() }, linkProps),
        h("slot", null),
        this.dismissable && (h("button", { part: "button-dismissable", disabled: this.disabled, "aria-label": this.dismissText },
          h("scale-icon-action-close", Object.assign({ part: "icon-dismissable", size: this.size === 'small' ? 20 : 24 }, iconProps)))))));
  }
  getBasePartMap() {
