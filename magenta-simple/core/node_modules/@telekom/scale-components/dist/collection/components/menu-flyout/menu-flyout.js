 ...
 */
import { Component, Prop, h, Host, Element, Event, Listen, Watch, State, } from '@stencil/core';
...
export class MenuFlyout {
  ...
  render() {
    return (h(Host, null,
      ...
      h("div", { class: this.getCssClassMap(), ref: (el) => (this.main = el), 
        // onClick={this.handleClick}
        onKeyDown: this.handleKeyDown, onKeyUp: this.handleKeyUp },
        h("div", { class: `${name}__click-catcher`, onTouchStart: this.onCatcherClick, onClick: this.onCatcherClick, onKeyDown: this.onCatcherClick, onKeyUp: this.onCatcherClick, onWheel: this.onCatcherScroll }),
        h("div", { class: `${name}__list-wrapper`, ref: (el) => (this.listWrapper = el) },
          h("div", { class: `${name}__list`, ref: (el) => (this.list = el), onClick: this.onMenuClick },
            h("slot", { onSlotchange: (e) => {
        ...
        h("span", { class: `${name}__trigger`, onClick: this.onTriggerClick, ref: (el) => (this.trigger = el) },
          h("slot", { name: "trigger", onSlotchange: (e) => {
  ...
  static get properties() { return {
    "closeOnSelect": {
      ...
      "docs": {
        "tags": [],
        "text": "(optional) Determines whether the dropdown should close when a menu item is selected"
      },
    ...
    "open": {
      ...
      "docs": {
        "tags": [],
        "text": "(optional) Tracks the menu list open state"
      },
      "attribute": "open",
      "reflect": true,
      "defaultValue": "false"
  ...
  static get events() { return [{
      ...
      "complexType": {
        "original": "{\n    id: number;\n    cascadeLevel: number;\n  }",
        "resolved": "{ id: number; cascadeLevel: number; }",
        "references": {}
      }
    }, {
      "method": "scaleClose",
      ...
      "docs": {
        "tags": [],
        "text": "Event triggered when nested menu item selected"
      },
      "complexType": {
        "original": "{\n    item: HTMLElement;\n  }",
  ...
  static get listeners() { return [{
      ...
      "name": "scaleClose",
      "method": "childClosedHandler",
      "target": undefined,
      "capture": false,
      "passive": false
    }, {
      "name": "scaleOpen",
      "method": "relativeOpenHandler",
      "target": "body",
      "capture": false,
      "passive": false
    }]; }
