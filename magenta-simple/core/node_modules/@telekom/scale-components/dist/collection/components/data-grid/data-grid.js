...
export class DataGrid {
  ...
  renderSettingsMenu() {
    return (h("scale-menu-flyout", { class: `${name}__settings-menu` },
      h("scale-button", { slot: "trigger", variant: "secondary", "icon-only": true },
        h("scale-icon-service-settings", null)),
      h("scale-menu-flyout-list", null,
        this.isSortable && (h("scale-menu-flyout", null,
          h("scale-menu-flyout-item", { slot: "trigger", cascade: true },
            h("scale-icon-action-sort", { slot: "prefix" }),
            "Sort By"),
          h("scale-menu-flyout-list", null, this.fields.map(({ label, type, sortable, sortDirection = 'none' }, columnIndex) => {
            if (!sortable) {
              return '';
            }
            return (h("scale-menu-flyout-item", { onClick: () => this.toggleTableSorting(sortDirection, columnIndex, type) },
        ...
        h("scale-menu-flyout", { "close-on-select": "false" },
          h("scale-menu-flyout-item", { slot: "trigger", cascade: true },
            h("scale-icon-action-hide-password", { slot: "prefix" }),
            "Toggle Visibility"),
          h("scale-menu-flyout-list", null, this.fields.map(({ label, type, visible = CELL_TYPES[type].defaults.visible !== undefined
  ...
  renderTable() {
    ...
    return (h("div", { ref: (el) => (this.elScrollContainer = el), class: `${name}__scroll-container`, style: { height: this.height || 'auto' }, onScroll: () => this.onTableScroll() },
      h("table", { class: `${name}__table`, role: "table", "aria-rowcount": this.rows.length, "aria-colcount": this.fields.length },
  ...
  renderTableHead() {
    return (h("thead", { ref: (el) => (this.elTableHead = el), class: `thead`, role: "rowgroup" },
      h("tr", { class: `thead__row`, role: "row" },
          ...
          return (h("th", Object.assign({}, props),
            h("div", { class: `thead__title` },
              h("span", { class: `thead__text` },
                ...
                label)),
            sortable && (h("button", { class: `thead__sort-prompt`, onClick: () => this.toggleTableSorting(sortDirection, columnIndex, type) })),
            resizable && (h("div", { class: `thead__divider`, "data-index": columnIndex, "data-width": width, "data-min": minWidth, "data-max": maxWidth, onMouseDown: (e) => this.onDividerDown(e), onTouchStart: (e) => this.onDividerDown(e) },
  ...
  renderTableHeadSelectableCell() {
    ...
    return (h("th", { class: `thead__cell thead__cell--selection`, style: style },
      h("scale-checkbox", { ref: (el) => (this.elToggleSelectAll = el), onScaleChange: () => this.toggleSelectAll() })));
  }
  renderTableBody() {
    return (h("tbody", { class: `tbody`, role: "rowgroup" }, (() => {
      ...
      for (let rowIndex = start; rowIndex < end; rowIndex++) {
        ...
        rows.push(h("tr", { class: `tbody__row`, role: "row", "aria-rowindex": rowIndex + 1 },
  ...
  renderTableBodySelectableCell(rowIndex) {
    ...
    return (h("td", { class: `tbody__cell tbody__cell--selection`, style: style },
      h("scale-checkbox", { checked: this.rows[rowIndex].selected, onScaleChange: (e) => this.toggleRowSelect(e, rowIndex) })));
  }
  renderTableCell(field, content, rowIndex, columnIndex) {
    ...
    return (h("td", { class: `tbody__cell${mobileTitle ? ` tbody__cell--used-as-mobile-title` : ``}`, style: { width: `calc(${width}px + ${stretchWidth}px)` }, role: "cell", "aria-columnindex": columnIndex },
  ...
  static get properties() { return {
    ...
    "visible": {
      ...
      "docs": {
        "tags": [],
        "text": "(optional) Set to falseto hide table, used for nested tables to re-render upon toggle"
      },
      "attribute": "visible",
      "reflect": false,
      "defaultValue": "true"
