 ...
 */
import { Component, h, Prop, Host, State, Listen, Element, } from '@stencil/core';
...
export class Shell {
  ...
  render() {
    return (h(Host, null,
      ...
      h("div", { part: classNames('base', this.scrolled && 'sticky'), class: this.getCssClassMap() },
