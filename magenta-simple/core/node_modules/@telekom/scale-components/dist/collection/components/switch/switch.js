  ...
  render() {
    return (h(Host, null,
      h("div", { class: this.getCssClassMap() },
        h("label", { id: `${this.inputId}-label` },
          h("input", { type: "checkbox", checked: this.checked, disabled: this.disabled, "aria-pressed": this.checked, "aria-labelledby": `${this.inputId}-label`, id: this.inputId, onChange: (e) => {
              this.checked = e.target.checked;
              // bubble event through the shadow dom
              this.scaleChange.emit({ value: this.checked });
            } }),
          h("div", { class: "switch__wrapper" },
            h("div", { class: "switch__toggle" }),
            h("div", { class: "switch__text" })),
          this.label && h("span", { class: "switch__label" }, this.label)))));
  }
  getCssClassMap() {
