  ...
  render() {
    return (h(Host, null,
      ...
      h("div", { ref: (el) => (this.modalContainer = el), class: this.getCssClassMap(), part: classNames('base', this.isOpen && 'open') },
        h("div", { class: "modal__backdrop", part: "backdrop", onClick: () => (this.opened = false) }),
        h("div", { "data-focus-trap-edge": true, onFocus: this.handleTopFocus, tabindex: "0" }),
        h("div", { class: "modal__window", part: classNames('window', this.size && `size-${this.size}`), ref: (el) => (this.modalWindow = el), role: "dialog", "aria-modal": "true" },
          h("div", { class: "modal__header", part: classNames('header', this.hasScroll && 'has-scroll') },
            ...
            h("button", { ref: (el) => (this.closeButton = el), class: "modal__close-button", part: "close-button", onClick: () => (this.opened = false), "aria-label": this.closeButtonLabel },
