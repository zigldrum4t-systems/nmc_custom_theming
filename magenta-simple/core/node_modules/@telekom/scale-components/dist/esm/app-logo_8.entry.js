import { r as registerInstance, h, g as getElement, c as createEvent, H as Host } from './index-5fb2d2c0.js';
import { c as classnames } from './index-349fc524.js';
import { r as renderIcon } from './render-icon-58b3b80d.js';
...
const NavIcon = class {
  ...
  render() {
    return (h("li", { class: this.getCssClassMap() }, h("a", { class: "meta-navigation__item-link", ref: this.refMobileMenuToggle, href: this.href, onClick: this.clickLink, onKeyDown: (event) => {
  ...
  getCssClassMap() {
    return classnames('meta-navigation__item', !!this.refMobileMenuToggle && 'mobile-menu', this.isMobileMenuOpen && 'open');
  }
};
...
const NavMain = class {
  ...
  render() {
    return (h(Host, null, h("li", { class: this.getCssClassMap() }, h("a", { class: "main-navigation__item-link", href: this.href, "aria-current": this.isActive ? 'true' : 'false', "aria-haspopup": this.hasSlotMegaMenu ? 'true' : 'false', tabIndex: 0, onClick: this.clickLink }, h("span", { class: "main-navigation__item-link-text" }, this.name), this.isActive && h("span", { class: "sr-only" }, "active")), h("slot", null))));
  }
  getCssClassMap() {
...
const NavSegment = class {
  ...
  render() {
    return (h("li", { class: this.getCssClassMap() }, h("a", { class: classnames('segment-navigation__item-link', this.isActive && 'active'), href: this.href, onFocus: () => {
        window.scrollTo({ top: 0 });
      }, "aria-current": this.isActive ? 'true' : 'false' }, h("slot", null), this.isActive && h("span", { class: "sr-only" }, "active"))));
  }
  getCssClassMap() {
...
export { Logo as app_logo, MegaMenu as app_mega_menu, MainNavigationMobile as app_navigation_main_mobile, NavigationSectorMobile as app_navigation_sector_mobile, NavigationLeft as scale_icon_navigation_left, NavIcon as scale_nav_icon, NavMain as scale_nav_main, NavSegment as scale_nav_segment };
