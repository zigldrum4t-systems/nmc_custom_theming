import { N as NAMESPACE, r as registerInstance, c as createEvent$1, h as h$1, g as getElement$1 } from './index-5fb2d2c0.js';
...
const DatePicker = class {
  constructor(hostRef) {
    ...
    this.scaleChange = createEvent$1(this, "scaleChange", 7);
    this.scaleBlur = createEvent$1(this, "scaleBlur", 7);
    this.scaleFocus = createEvent$1(this, "scaleFocus", 7);
    /**
     * Name of the date picker input.
     */
    this.name = 'date';
  ...
  render() {
    ...
    return (h$1("div", { class: classnames('scale-date-picker', this.status && `scale-date-picker--status-${this.status}`, this.hasFocus && 'scale-date-picker--focus', this.disabled && 'scale-date-picker--disabled', this.size && `scale-date-picker--size-${this.size}`, this.hasValue && 'animated') }, h$1("label", { class: "date-picker__label", htmlFor: this.identifier }, this.label), h$1("duet-date-picker", Object.assign({ onDuetChange: (e) => {
      ...
      // @ts-ignore
      ref: (element) => (this.duetInput = element) }, ariaInvalidAttr, ariaDescribedByAttr)), !!this.helperText && (h$1("div", { class: "date-picker__meta", id: helperTextId, "aria-live": "polite", "aria-relevant": "additions removals" }, h$1("div", { class: "date-picker__helper-text" }, this.helperText)))));
  }
