...
const RatingStars = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: this.getCssClassMap(), id: "rating", ref: (el) => (this.element = el), onMouseMove: this.handleMouseMove, onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave, onClick: this.handleMouseClick, onKeyDown: this.handleKeyDown, tabIndex: this.disabled ? -1 : 0, role: "figure", "aria-describedby": "rating__description", "aria-label": this.label }, index.h("label", { class: "rating__label", "aria-hidden": "true" }, this.label), index.h("span", { id: "rating__description", innerHTML: this.getAriaLabel(), hidden: true }), index.h("span", { class: "rating__symbols", "aria-hidden": "true" }, counter.map((index$1) => (index.h("span", { class: "rating__symbol__wrapper", onMouseEnter: this.handleMouseEnter }, index.h("span", { role: "presentation", style: {
        clipPath: Math.ceil(displayValue) >= index$1 + 1
          ? `inset(0 ${(Math.ceil(displayValue) - index$1) * 100}% 0 0)`
          : null,
      }, class: {
        rating__symbol: true,
        'rating__symbol--hover': this.isHovering && Math.ceil(displayValue) === index$1 + 1,
      }, innerHTML: this.getSymbol(this.colorBlank, this.size), id: `star-${index$1 + 1}` }))))), index.h("span", { class: "rating__symbols rating__symbols--indicator", "aria-hidden": "true" }, counter.map((index$1) => (index.h("span", { class: "rating__symbol__wrapper", onMouseEnter: this.handleMouseEnter }, index.h("span", { role: "presentation", style: {
        clipPath: displayValue > index$1 + 1
          ? null
  ...
  getCssClassMap() {
    return index$1.classnames('rating', this.disabled && 'rating--disabled', this.isHovering && 'rating--hover', this.small && 'rating--small', this.label && 'rating--has-label');
  }
