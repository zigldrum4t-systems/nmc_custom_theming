...
const Modal = class {
  ...
  render() {
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("div", { ref: (el) => (this.modalContainer = el), class: this.getCssClassMap(), part: index$1.classnames('base', this.isOpen && 'open') }, index.h("div", { class: "modal__backdrop", part: "backdrop", onClick: () => (this.opened = false) }), index.h("div", { "data-focus-trap-edge": true, onFocus: this.handleTopFocus, tabindex: "0" }), index.h("div", { class: "modal__window", part: index$1.classnames('window', this.size && `size-${this.size}`), ref: (el) => (this.modalWindow = el), role: "dialog", "aria-modal": "true" }, index.h("div", { class: "modal__header", part: index$1.classnames('header', this.hasScroll && 'has-scroll') }, index.h("h2", { class: "modal__heading", part: "heading" }, this.heading), index.h("button", { ref: (el) => (this.closeButton = el), class: "modal__close-button", part: "close-button", onClick: () => (this.opened = false), "aria-label": this.closeButtonLabel }, index.h("slot", { name: "close-icon" }, index.h("scale-icon-action-circle-close", { decorative: true })))), index.h("div", { ref: (el) => (this.modalBody = el), class: "modal__body-wrapper", part: index$1.classnames('body-wrapper', this.hasBody && 'has-body') }, index.h("div", { class: "modal__body", part: index$1.classnames('body', this.hasBody && 'has-body') }, index.h("slot", null))), index.h("div", { class: "modal__actions", part: index$1.classnames('actions', `align-${this.alignActions}`, this.hasActionsSlot && 'has-actions', this.hasScroll && 'has-scroll') }, index.h("slot", { name: "action" }))), index.h("div", { "data-focus-trap-edge": true, onFocus: this.handleBottomFocus, tabindex: "0" }))));
  }
  getCssClassMap() {
