...
const Button = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), this.href ? (index.h("a", { class: this.getCssClassMap(), href: this.href, target: this.target, rel: this.target === '_blank' ? 'noopener noreferrer' : undefined, "aria-label": this.ariaLabel, part: basePart }, index.h("slot", null))) : (index.h("button", { class: this.getCssClassMap(), onClick: this.handleClick, disabled: this.disabled, type: this.type, "aria-label": this.ariaLabel, part: basePart }, index.h("slot", null)))));
  }
  getCssClassMap() {
...
const Checkbox = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { checked: this.checked }, index.h("div", { class: this.getCssClassMap() }, index.h("label", { class: "checkbox__label-wrapper", htmlFor: this.inputId }, index.h("input", Object.assign({ type: "checkbox", name: this.name, id: this.inputId, onChange: (e) => {
        this.checked = e.target.checked;
        // bubble event through the shadow dom
        this.scaleChange.emit({ value: this.checked });
      }, value: this.value, checked: this.checked, disabled: this.disabled }, ariaInvalidAttr, ariaDescribedByAttr)), index.h("div", { class: "checkbox__control-wrapper" }, index.h("span", { class: "checkbox__control" }), this.checked && (index.h("scale-icon-action-success", { decorative: true }))), index.h("span", { class: "checkbox__label" }, this.label ? this.label : index.h("slot", null)), !!this.helperText && (index.h("div", { class: "checkbox__meta", id: helperTextId, "aria-live": "polite", "aria-relevant": "additions removals" }, index.h("div", { class: "checkbox__helper-text" }, this.helperText)))))));
  }
  getCssClassMap() {
    return index$1.classnames('checkbox', this.checked && `checkbox--checked`, this.disabled && `checkbox--disabled`, this.status && `checkbox--status-${this.status}`);
  }
...
const Dropdown = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.scaleInput = index.createEvent(this, "scaleInput", 7);
    this.scaleChange = index.createEvent(this, "scaleChange", 7);
    this.scaleFocus = index.createEvent(this, "scaleFocus", 7);
    this.scaleBlur = index.createEvent(this, "scaleBlur", 7);
    this.scaleKeyDown = index.createEvent(this, "scaleKeyDown", 7);
    /** (optional) Input name */
    this.name = '';
    /** (optional) Input label */
    this.label = '';
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: this.getCssClassMap() }, index.h("label", { class: "input__label", htmlFor: this.inputId }, this.label), index.h("div", { class: "input__dropdown-wrapper" }, index.h("select", Object.assign({ ref: (el) => (this.selectElement = el), class: "input__dropdown",
      // @ts-ignore
      value: this.value, onChange: this.handleSelectChange, onFocus: this.handleFocus, onBlur: this.handleBlur, onKeyDown: this.handleKeyDown, disabled: this.disabled, required: this.required, multiple: this.multiple, id: this.inputId, name: this.name, size: this.visibleSize }, ariaInvalidAttr, ariaDescribedByAttr), index.h("slot", null)), index.h("div", { class: "input__dropdown-icon" }, this.hasSlotIcon ? (index.h("slot", { name: "icon" })) : (index.h("scale-icon-navigation-collapse-down", { decorative: true })))), !!this.helperText && (index.h("div", { class: "input__meta", id: helperTextId, "aria-live": "polite", "aria-relevant": "additions removals" }, !!this.helperText && (index.h("div", { class: "input__helper-text" }, this.helperText)))))));
  }
  getCssClassMap() {
    return index$1.classnames('dropdown', this.disabled && `dropdown--disabled`, this.transparent && 'dropdown--transparent', this.status && `dropdown--status-${this.status}`, this.size && `dropdown--size-${this.size}`, this.value != null && this.value !== '' && 'animated');
  }
  get hostElement() { return index.getElement(this); }
};
...
const Link = class {
  ...
  render() {
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("a", Object.assign({ class: this.getCssClassMap(), part: index$1.classnames('base', this.disabled && 'disabled'), href: this.disabled ? 'javascript:void(0)' : this.href }, (!this.disabled ? { target: this.target } : {}), { "aria-disabled": this.disabled }), index.h("span", { class: "link__wrapper", part: "wrapper" }, index.h("slot", null), index.h("slot", { name: "icon" })))));
  }
  getCssClassMap() {
    return index$1.classnames('link', this.disabled && 'link--disabled', this.block && 'link--block');
  }
};
Link.style = linkCss;
...
const MenuFlyout = class {
  ...
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.scaleOpen = index.createEvent(this, "scaleOpen", 7);
    this.scaleClose = index.createEvent(this, "scaleClose", 7);
    this.scaleSelect = index.createEvent(this, "scaleSelect", 7);
  ...
  /* 9. Local Methods */
  getCssClassMap() {
    return index$1.classnames(name, this.open && `${name}--open`, this.isCascaded && `${name}--cascaded`, `${name}--direction-${this.direction}`, this.flipHorizontal && `${name}--flip-horizontal`, this.flipVertical && `${name}--flip-vertical`);
  }
  ...
  /* 10. Render */
  render() {
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("div", { class: this.getCssClassMap(), ref: (el) => (this.main = el),
      // onClick={this.handleClick}
      onKeyDown: this.handleKeyDown, onKeyUp: this.handleKeyUp }, index.h("div", { class: `${name}__click-catcher`, onTouchStart: this.onCatcherClick, onClick: this.onCatcherClick, onKeyDown: this.onCatcherClick, onKeyUp: this.onCatcherClick, onWheel: this.onCatcherScroll }), index.h("div", { class: `${name}__list-wrapper`, ref: (el) => (this.listWrapper = el) }, index.h("div", { class: `${name}__list`, ref: (el) => (this.list = el), onClick: this.onMenuClick }, index.h("slot", { onSlotchange: (e) => {
      ...
      } }))), index.h("span", { class: `${name}__trigger`, onClick: this.onTriggerClick, ref: (el) => (this.trigger = el) }, index.h("slot", { name: "trigger", onSlotchange: (e) => {
...
const MenuFlyoutItem = class {
  ...
  /* 9. Local Methods */
  getCssClassMap() {
    return index$1.classnames(name$1, this.disabled && `${name$1}--disabled`, this.hasFocus && `${name$1}--focused`, this.active && `${name$1}--active`);
  }
  /* 10. Render */
  render() {
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("div", { class: this.getCssClassMap(), ref: (el) => (this.menuItem = el), part: "base", role: "menuitem", tabindex: "-1", "aria-disabled": this.disabled ? 'true' : 'false', onFocus: () => (this.hasFocus = true), onBlur: () => (this.hasFocus = false), onMouseEnter: () => this.setFocus(), onMouseLeave: () => this.removeFocus(), onTouchStart: () => this.setFocus(), onTouchEnd: () => this.removeFocus() }, index.h("span", { part: "prefix", class: `${name$1}__prefix` }, this.checked === undefined ? (index.h("slot", { name: "prefix" })) : (index.h("scale-icon-action-success", { class: `${name$1}__check`, style: {
        opacity: !this.checked || this.checked === 'false' ? '0' : '1',
      }, size: 16 }))), index.h("span", { part: "label", class: `${name$1}__label` }, index.h("slot", null)), index.h("span", { part: "suffix", class: `${name$1}__suffix` }, this.cascade ? (index.h("scale-icon-navigation-right", { class: `${name$1}__cascade`, size: 16, slot: "suffix" })) : (index.h("slot", { name: "suffix" }))))));
  }
  get hostElement() { return index.getElement(this); }
};
...
const MenuFlyoutList = class {
  ...
  /* 9. Local Methods */
  getCssClassMap() {
    return index$1.classnames(name$2, this.canScrollUp && `${name$2}--can-scroll-up`, this.canScrollDown && `${name$2}--can-scroll-down`);
  }
  ...
  /* 10. Render */
  render() {
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("div", { class: this.getCssClassMap(), ref: (el) => (this.menu = el), part: "base", role: "menu", tabindex: "0", onScroll: this.onMenuScroll, onWheel: this.onMenuWheel }, index.h("slot", null), index.h("div", { class: `${name$2}__scroll-up-indicator` }), index.h("div", { class: `${name$2}__scroll-down-indicator` }))));
  }
  get hostElement() { return index.getElement(this); }
};
...
const Pagination = class {
  ...
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.scalePagination = index.createEvent(this, "scalePagination", 7);
    /* 2. State Variables (alphabetical) */
    /* 3. Public Properties (alphabetical) */
  ...
  render() {
    ...
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("div", { part: this.getBasePartMap(), class: this.getCssClassMap() }, index.h("button", { class: `${name$3}__first-prompt`, part: "first-prompt", disabled: isAtStart, onClick: () => this.goFirstPage() }, index.h("svg", { height: "17", viewBox: "0 0 48 52", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "#cacaca" }, index.h("path", { d: "M44.5 48.5L21.5 26L44.5 3.5M27.5 48.5L4.5 26L27.5 3.5", "stroke-width": "6", "stroke-linecap": "round" }))), index.h("button", { class: `${name$3}__prev-prompt`, part: "prev-prompt", disabled: isAtStart, onClick: () => this.goPreviousPage() }, index.h("svg", { height: "17", viewBox: "0 0 37 52", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "#cacaca" }, index.h("path", { d: "M33 48L6 26L33 4", "stroke-width": "7", "stroke-linecap": "round" }))), index.h("div", { part: "info", class: `${name$3}__info`, style: { width: `${this.maxWidth}px` } }, index.h("span", null, start, "-", end), ' ', "/ ", total), index.h("button", { class: `${name$3}__next-prompt`, part: "next-prompt", disabled: isAtEnd, onClick: () => this.goNextPage() }, index.h("svg", { height: "17", viewBox: "0 0 37 52", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "#cacaca" }, index.h("path", { d: "M4 4L31 26L4 48", "stroke-width": "7", "stroke-linecap": "round" }))), index.h("button", { class: `${name$3}__last-prompt`, part: "last-prompt", disabled: isAtEnd, onClick: () => this.goLastPage() }, index.h("svg", { height: "17", viewBox: "0 0 48 52", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "#cacaca" }, index.h("path", { d: "M3.5 3.5L26.5 26L3.5 48.5M20.5 3.5L43.5 26L20.5 48.5", "stroke-width": "6", "stroke-linecap": "round" }))))));
  }
  getBasePartMap() {
  ...
  getCssOrBasePartMap(mode) {
    ...
    return index$1.classnames(name$3, this.hideBorders && `${prefix}hide-borders`);
  }
  get hostElement() { return index.getElement(this); }
  static get watchers() { return {
...
const Switch = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: this.getCssClassMap() }, index.h("label", { id: `${this.inputId}-label` }, index.h("input", { type: "checkbox", checked: this.checked, disabled: this.disabled, "aria-pressed": this.checked, "aria-labelledby": `${this.inputId}-label`, id: this.inputId, onChange: (e) => {
        this.checked = e.target.checked;
        // bubble event through the shadow dom
        this.scaleChange.emit({ value: this.checked });
