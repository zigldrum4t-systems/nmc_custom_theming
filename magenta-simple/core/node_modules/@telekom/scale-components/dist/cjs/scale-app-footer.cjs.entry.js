...
const AppFooter = class {
  ...
  footerMenu() {
    return (index.h("ul", null, readData(this.footerNavigation).map((item) => (index.h("li", { class: "footer-navigation__item" }, index.h("a", { class: "footer-navigation__item-link", href: item.href || 'javascript:void(0);', onClick: (event) => {
        if (typeof item.onClick === 'function') {
          item.onClick(event);
        }
      } }, item.icon &&
      renderIcon.renderIcon(item.icon, 'footer-navigation__item-link'), index.h("span", null, item.name)))))));
  }
  iconDefs() {
    return (index.h("template", null, index.h("svg", null, index.h("defs", null, index.h("g", { id: "icon-alert-imprint-dataprivacy" }, index.h("path", { d: "M12 1l9.5 2.15v8c0 2.85-.95 5.55-2.6 7.75-2.6 3.4-5.85 4.35-6.9 4.65-4.2-1.2-6.25-3.8-6.7-4.4-1.75-2.25-2.8-5.05-2.8-8v-8zm0 1.5L4 4.35v6.8c0 4.95 3.3 9.35 8 10.8 4.7-1.45 8-5.85 8-10.8v-6.8zM10.6 13l1.4 1.4 1.4-1.4h1c.95 0 1.75.7 1.95 1.65l.15.85h-9l.15-.85C7.8 13.7 8.65 13 9.6 13zM12 6.5c1.4 0 2.5 1 2.5 2.5 0 1.55-1.05 3-2.5 3s-2.5-1.5-2.5-3 1.1-2.5 2.5-2.5z", "fill-rule": "evenodd" }))))));
  }
  render() {
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("div", { class: this.getCssClassMap() }, index.h("div", { class: "footer-mask" }), index.h("footer", { class: "footer" }, this.iconDefs(), index.h("div", { class: "footer-content" }, index.h("div", { class: "footer-branding" }, index.h("app-logo", { claim: true, claimLang: this.claimLang })), index.h("div", { class: "footer-copyright" }, this.copyright), index.h("nav", { "aria-label": "bottom", class: "footer-navigation" }, this.footerMenu()))))));
  }
  getCssClassMap() {
