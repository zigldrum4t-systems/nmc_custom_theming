...
const DatePicker = class {
  ...
  render() {
    ...
    return (index.h("div", { class: index$1.classnames('scale-date-picker', this.status && `scale-date-picker--status-${this.status}`, this.hasFocus && 'scale-date-picker--focus', this.disabled && 'scale-date-picker--disabled', this.size && `scale-date-picker--size-${this.size}`, this.hasValue && 'animated') }, index.h("label", { class: "date-picker__label", htmlFor: this.identifier }, this.label), index.h("duet-date-picker", Object.assign({ onDuetChange: (e) => {
      ...
      // @ts-ignore
      ref: (element) => (this.duetInput = element) }, ariaInvalidAttr, ariaDescribedByAttr)), !!this.helperText && (index.h("div", { class: "date-picker__meta", id: helperTextId, "aria-live": "polite", "aria-relevant": "additions removals" }, index.h("div", { class: "date-picker__helper-text" }, this.helperText)))));
  }
