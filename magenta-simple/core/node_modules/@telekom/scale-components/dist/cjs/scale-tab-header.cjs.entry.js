...
const TabHeader = class {
  ...
  render() {
    return (index.h(index.Host, { id: `scale-tab-header-${this.generatedId}`, role: "tab", "aria-selected": String(this.selected), tabindex: this.selected ? '0' : '-1', onFocus: () => (this.hasFocus = true), onBlur: () => (this.hasFocus = false) }, this.styles && index.h("style", null, this.styles), index.h("span", { part: this.getBasePartMap(), ref: (el) => (this.container = el), class: this.getCssClassMap() }, index.h("slot", null))));
  }
  getBasePartMap() {
  ...
  getCssOrBasePartMap(mode) {
    ...
    return index$1.classnames(component, this.selected && `${prefix}selected`, this.small && `${prefix}small`, this.hasFocus && `${prefix}has-focus`);
  }
