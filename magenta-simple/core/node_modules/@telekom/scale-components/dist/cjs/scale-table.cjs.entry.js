...
const Table = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.getCssClassMap() }, index.h("slot", null)));
  }
  getCssClassMap() {
    return index$1.classnames('table', this.size && `table--size-${this.size}`, this.showSort && 'table--sortable');
  }
